...
\begin{lstlisting}
https://github.com/BatharajuRamana/ASSIGNMENT-6/tree/main/CODES
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/BatharajuRamana/ASSIGNMENT-6/tree/main
\end{lstlisting}
%
\section{Question No 2.27}
prove that the three points $ \myvec{ -4 \\ 6 \\ 10}$ , $\myvec{2 \\ 4 \\ 6}$   \text {and} $\myvec{14 \\ 0 \\ -2}$ are collinear.
%
\section{SOLUTION} 
Let,
\begin{align}
